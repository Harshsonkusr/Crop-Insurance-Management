...
import ServiceProviderClaimManagement from "./pages/ServiceProvider/ServiceProviderClaimManagement";
import ServiceProviderClaimDetails from "./pages/ServiceProvider/ServiceProviderClaimDetails";
import ServiceProviderCropManagement from "./pages/ServiceProvider/ServiceProviderCropManagement";
        ...
        <main className="flex-1">
          <Routes>
            ...
            >
              ...
              <Route path="claim-management" element={<ServiceProviderClaimManagement />} />
            ...
            <Route path="crop-management" element={<ServiceProviderCropManagement />} />
